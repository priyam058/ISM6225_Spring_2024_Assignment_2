        ...
        */
        ...
        public static int RemoveDuplicates(int[] nums)
        {
            try
            {
                ...
                int uniqueCount = 1; // At least one unique element present
                ...
                // Fill remaining elements with underscores
        ...
        */
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                ...
                // Traverse the array, if the element is non-zero, swap it with the nonZeroIndex
